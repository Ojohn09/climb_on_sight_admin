    ...
    return (
        <div className=" p-3">
            <div className="bg-[#F4E8DF] h-[90%] fixed border border-r menu flex flex-col items-start justify-between z-40 p-3 w-[50px] 3xl:w-[70px] 3xl:px-5 ">
                ...
                <div className="flex flex-col items-center gap-2 2xl:text-xl text-gray-400">
                    <Link to='/dashboard'>
                    ...
                    <Link to='/guides'>
                        <div className="menu-icon flex items-center gap-2 p-1">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 3xl:h-7" viewBox="0 0 23 20" fill="none">
                    ...
                    <Link to='/climbers'>
                        <div className=" menu-icon flex items-center gap-2 p-1">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 3xl:h-7" viewBox="0 0 18 20" fill="none">
                                <g opacity="">
