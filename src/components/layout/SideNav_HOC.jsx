...
function SideNav_HOC() {
    return (
        <div className=" p-3">
            <div className="bg-[#F4E8DF] h-[90%] fixed border border-r menu flex flex-col items-start justify-around gap-[150px] z-40 p-3 w-[50px]">
                <div>
...
<<<<<<< Updated upstream
                            <p className="menu-text text-black font-semibold">Charts</p> </div>
=======
                            <p className="menu-text text-black font-semibold">Statistics</p> </div>
>>>>>>> Stashed changes
                    </Link>
                    <Link to='/events'>
                        <div className="menu-icon flex items-center gap-2">
