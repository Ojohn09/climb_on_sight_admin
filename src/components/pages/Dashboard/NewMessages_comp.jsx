        ...
        <div className="flex gap-4 flex-col mt-2 md:flex-row">
            <div className="md:w-[65%]">
                <div>
                    ...
                    <div className="flex flex-col  sm:grid grid-cols-2 bg-white rounded-xl text-[8px] xl:text-[10px] p-2 2xl:p-4 3xl:text-sm">
                        <div className="flex items-center gap-2 px-2 border-r border-b">
                            ...
                            <div className="w-[70%]">
                                <p>Andrey Finn</p>
                                <p className="text-gray-500 text-[7px] xl:text-[8px] 2xl:text-xs 3xl:text-xs 4xl:text-sm">Hello, Good day i would love to make an enquiry .... </p>
                            </div>
                        ...
                        <div className="flex items-center gap-2 px-2 border-b">
                            ...
                            <div className="w-[70%]">
                                <p>Andrey Finn</p>
                                <p className="text-gray-500 text-[7px] xl:text-[8px] 2xl:text-xs 3xl:text-sm 4xl:text-lg">Hello, Good day i would love to make an enquiry .... </p>
                            </div>
                            <p className="p-1 px-2 2xl:px-3 2xl:p-1.5 text-white bg-black rounded-full flex">
                                3
                            </p>
